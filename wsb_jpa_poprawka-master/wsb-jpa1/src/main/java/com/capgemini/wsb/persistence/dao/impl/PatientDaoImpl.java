...
public class PatientDaoImpl extends AbstractDao<PatientEntity, Long> implements PatientDao {
    ...
    public void delete(PatientEntity patient) {
        entityManager.createQuery("DELETE FROM MedicalTreatmentEntity m WHERE m IN (SELECT mt FROM MedicalTreatmentEntity mt JOIN mt.visit v WHERE v.patient = :patient)")
